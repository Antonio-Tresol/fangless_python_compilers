...
print(-(not True))         # Expected:  0
print(~(not False))        # Expected: -2
print(-~0)                 # Expected:  1 
print(~-42)                # Expected: 41 
print(-(not False))        # Expected: -1 
print(~(not True))         # Expected: -1 
print(-sum([1, 2, 3]))     # Expected: -6 


print("\nAdvanced Expressions:")
print(~(5 & 3))              # Expected: -2
print(-(not (8 % 2 == 0)))   # Expected: 0
print(-(~(5 << 1)))          # Expected: 11
print(~len("test"))          # Expected: -5
